function [ r_square,apantisi,pval] = r_square_angular_linear_correlation_v4( x_linear,y_angles )

% Or by "Zar's biostatistical analysis" vrs5 page 658
% eg 
% r_square_angular_linear_correlation_v4( [1 2 3],[90 100 110] )
% r_square_angular_linear_correlation_v4( [1 2 3],[110 100 90] )
% r_square_angular_linear_correlation_v4( [1 2 3],[0 300 200] )
% eg by Zah's vrs5 page 658
% [ r_square,apantisi,pval] = r_square_angular_linear_correlation_v4( [48 55 26 23 22 62 64],[190 160 210 225 220 140 120] )
...
if r_square > 1+1e-5 || r_square < 0
    r_square
    error(['Re-write this function, MALAKA!',' r_square=',num2str(r_square),...
        ' instead ob belonging in [0,1]'])
end
