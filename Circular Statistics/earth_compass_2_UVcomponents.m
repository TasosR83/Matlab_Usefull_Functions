function [u,v] = earth_compass_2_UVcomponents(degrees,velocity, varargin)
...
% degrees = [0 90 100] ; velocity = [9 2 3]; [u,v] = earth_compass_2_UVcomponents(degrees,velocity)
% degrees = [0 90 100] ; velocity = ones(size(degrees)); [u,v] = earth_compass_2_UVcomponents(degrees,velocity)

% degrees = [0 90 100 180 270 360] ; velocity = ones(size(degrees)); [u,v] = earth_compass_2_UVcomponents(degrees,velocity)
